...
//require ('public/shortcode/sami.php');

/**
 * The code that runs during plugin activation.
 * This action is documented in includes/wp-recruitment-activator.php
 */

register_activation_hook( __FILE__, array('sample-metabox','plugin_activation'));
register_deactivation_hook( __FILE__, array( 'sample-metabox', 'plugin_deactivation' ) );


require plugin_dir_path(__FILE__).'lib/cmb2/init.php';
